...
//    canvas.drawRect(mOval, _mPaint);  // 矩形区域
    ...
    var textName =pieData.name;
    var textNum =pieData.price;
    var tp1 = _newVerticalAxisTextPainter(texts)..layout();

    // Text的绘制起始点 = 可用宽度 - 文字宽度 - 左边距
    var textLeft = 37.0;//横向
    tp1.paint(canvas, Offset(textLeft, 50.0 - tp1.height / 2));
    textLeft = 37.0;
    var tp2 = _newVerticalAxisTextPainter(textName)..layout();
    tp2.paint(canvas, Offset(textLeft, 70.0 - tp2.height / 2));
