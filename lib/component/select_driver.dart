...
class SelectDriverPage extends StatefulWidget {
  @override
  SelectDriverPageState createState() => SelectDriverPageState();
}

class SelectDriverPageState extends State<SelectDriverPage> {
  ...
  Widget _itemBuild(eppDropDown) {
    return Container(
      color: Colors.white,
      child: ListTile(
          title: Text(eppDropDown['personalName']),
          onTap: () {
            setState(() {
