...
/// 选择助记码
class SelectMnemonicCodePage extends StatefulWidget {
  @override
  SelectMnemonicCodePageState createState() => SelectMnemonicCodePageState();
}

class SelectMnemonicCodePageState extends State<SelectMnemonicCodePage> {
  ...
  _loadDate() async {
    if (!isloading) {
      ...
      await getMnemonicCodeList(page);
  ...
  Widget _itemBuild(eppDropDown) {
    return Container(
      color: Colors.white,
      child: ListTile(
          title: Text(eppDropDown['goodsName'].toString()),
          subtitle: Text(eppDropDown['specification'].toString()),
          onTap: () {
            setState(() {
