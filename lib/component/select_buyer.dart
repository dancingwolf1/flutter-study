...
/// 选择申请人
class SelectAccessoriesPage extends StatefulWidget {
  @override
  SelectAccessoriesPageState createState() => SelectAccessoriesPageState();
}

class SelectAccessoriesPageState extends State<SelectAccessoriesPage> {
  ...
  Widget _itemBuild(eppDropDown) {
    return Container(
      color: Colors.white,
      child: ListTile(
          title: Text(eppDropDown['empname']),
          onTap: () {
            setState(() {
